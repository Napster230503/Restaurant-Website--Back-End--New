...
<html lang="en">
  ...
  <body>
    ...
    <div class="card" style="width: 30rem; margin: 20px auto">
      ...
      <div class="card-body">
        ...
        <form action="post" class="mt-5">
          ...
          <button type="button" class="btn btn-danger mt-4 ms-5"><a href="ice_cream.html" style="color: white; text-decoration: none">Batal</a></button>
        </form>
      </div>
    </div>
    ...
    <script>
      function mult() {
        let eskrim = document.getElementById('harga');
        let harga = Number(eskrim.value) * 10000;
