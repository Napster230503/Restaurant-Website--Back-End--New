      ...
      <div id="layoutSidenav_content">
                ...
                <fieldset>
                            <div class="mb-3 row">
                              ...
                              <div class="mb-3 row">
                                <label for="price" class="col-sm-2 col-form-label">Mail</label>
                                <div class="col-sm-10">
                                  <input value="<?php echo $mail; ?>"type="text" class="form-control"  id="zipcode" name="mail" placeholder="0" required="true">
                                </div>
                              </div>
                              <div class="mb-3 row">
